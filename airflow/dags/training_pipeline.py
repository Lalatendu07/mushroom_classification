...
with DAG(
    'mushroom_classification_training',
    default_args={'retries': 2},
    # [END default_args]
    description='Mushroom Classification',
    schedule_interval="@weekly",
    start_date=pendulum.datetime(2023, 4, 14, tz="UTC"),
    catchup=False,
    tags=['example'],
) as dag:
    ...
    def training(**kwargs):
        from mushroom_clf.pipeline.training_pipeline import start_training_pipeline
